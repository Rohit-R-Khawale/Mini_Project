  ...
  return (
    <main>
      ...
      <nav className='flex gap-2 bg-white h-10'>
            ...
            {
              isTeacher && 
              <Link to='/cardcontent/marks' className='hover:bg-blue-100 hover:text-blue-600 hover:cursor-pointer pt-2 hover:border-b-4 hover:border-blue-500 px-4 '>Marks</Link>
            }
        </nav>
        <hr />
    </main>
